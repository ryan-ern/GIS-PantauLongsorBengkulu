  ...
  <body>
    ...
    <div class="container">
      <div class="cards">
        <div>
          <h5>
            Belum ada informasi peringatan dini Tetap siaga dan waspada terhadap
            setiap kemungkinan bencana
          </h5>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-sm">
            ...
            <div class="card" style="width: 15rem;">
              <div class="">
                <img
                  src="https://github.com/indraphy/gambar/blob/main/peta.jpg?raw=true"
                  class="card-img-top"
                  alt="..."
                  height="200px"
                />
          ...
          <div class="col-sm">
            ...
            <div class="card" style="width: 15rem;">
              <div class="">
                <img
                  src="https://github.com/indraphy/gambar/blob/main/datainfo.png?raw=true"
                  class="card-img-top"
                  alt="..."
                  height="200px"
                />
          ...
          <div class="col-sm">
            ...
            <div class="card" style="width: 15rem;">
              <div class="">
                <img
                  src="https://github.com/indraphy/gambar/blob/main/img-3.PNG?raw=true"
                  class="card-img-top"
                  alt="..."
                  height="200px"
                />
